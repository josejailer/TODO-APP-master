...
import co.edu.ucc.todolist.vistas.fragmentos.RecuperarPasswordFragment;
...
public class AuthActivity extends AppCompatActivity
        ...
        RegistroFragment.OnRegistroInteractionListener,RecuperarPasswordFragment.OnFragmentInteractionListener{
    ...
    public void irARecordarPassword() {
        ...
        transaction.replace(R.id.frameAuthActivity, RecuperarPasswordFragment.newInstance());
        transaction.commit();
    }
